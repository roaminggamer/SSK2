...
function factory.new( group, x, y, params )
	...
	-- Create player 
	local player = newImageRect( group, x, y, "images/space_shooter/hplayer.png",
		{ 	w = 80, h = 80, alpha = 1 }, 
		{	radius = 35, calculator = myCC, colliderName = "player"} )
	...
	player.enterFrame = function( self )
		...
		self:setLinearVelocity( common.playerVelocity, vy * 300, self.x, self.y )
