...
function turrets.createTurret( x, y, aimRate )
	local turret = newImageRect( layers.content, x, y, "images/misc/arrow.png", { size = 100 } )
...
function turrets.createEnemy( )
	enemy = newImageRect( layers.content, left + 100, top + 200, "images/misc/rg256.png", { size = 80 } )
...
function turrets.fireBullet( event )
	if( event.phase == "began" ) then
		...
		local bullet = newImageRect( layers.content, pVec.x, pVec.y, "images/misc/arrow.png",
