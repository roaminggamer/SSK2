...
function example.run( group )
	...
	--
	player = newImageRect( group, centerX, centerY, "images/misc/arrow.png", { size = 40 }, { radius = 20 } )

	-- Create a 'target' to face
	--
	local target = newImageRect( group, centerX, centerY - 150, "images/misc/rg256.png", { size = 40 } )
