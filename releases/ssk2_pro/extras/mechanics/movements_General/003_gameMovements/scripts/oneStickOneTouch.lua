...
function example.run( group )
	...
	--
	player = newImageRect( group, centerX, centerY - 50, "images/misc/kenney1.png", { size = 80 }, { radius = 40 } )
...
drawRoom = function( group )
	...
	leftWall.fill = { type = "image", filename = "images/misc/kenney_wood.png" }
	leftWall.fill.scaleY = 80/fullh
	local rightWall = newRect( group, right, centerY, { w = 80, h = fullh  }, { bodyType = "static" } )
	rightWall.fill = { type = "image", filename = "images/misc/kenney_wood.png" }
	...
	floor.fill = { type = "image", filename = "images/misc/kenney_stone.png" }
	floor.fill.scaleX = 80/fullw
	local ceiling = newRect( group, centerX, top, { w = fullw, h = 80  }, { bodyType = "static" } )
	ceiling.fill = { type = "image", filename = "images/misc/kenney_stone.png" }
