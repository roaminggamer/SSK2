...
-- ==
player = newImageRect( group, centerX, centerY, "images/misc/arrow.png", { size = playerSize }, { } )
...
-- Left Button
--
local tmp = newImageRect( group, left + 75, bottom - 75, "images/ui/arrowLeft.png",
...
-- Right Button
--
local tmp = newImageRect( group, left + 200, bottom - 75, "images/ui/arrowRight.png",
