...
factoryMgr.register( "player", "factories.players.bouncing_ball1_ketchapp" )
factoryMgr.register( "coin", "factories.pickups.coin" )
factoryMgr.register( "platform", "factories.world.platform" )
factoryMgr.register( "spikes", "factories.dangers.spikes" )
...
--
game.init()
game.start( nil, { debugEn = true, hybridEn = false } )
