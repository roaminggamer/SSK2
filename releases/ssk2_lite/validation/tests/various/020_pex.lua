...
function test.run( group, params )
   ...
   -- Should partially obscure two of the effects
   local maskingImage = newImageRect( foreground, centerX, centerY, "images/back/protoBack.png", 
    { w = 760, h = 1140, rotation = 90, alpha = 0.8 })


 	-- ==========================================
   -- 1. Particle Designer Format
   -- ==========================================
   local emitter1 = ssk.pex.loadPD2( content, centerX - 200, centerY, 
   ...
   -- ==========================================
   local emitter2 = ssk.pex.loadRG( background, centerX, centerY, 
   ...
   -- 3. Starling Format
   -- ==========================================
   local emitter3 = ssk.pex.loadStarling( foreground, centerX + 200, centerY, 
